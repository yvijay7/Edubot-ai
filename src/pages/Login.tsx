        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/70 leading-relaxed">
              AI-powered study planning, curated resources from Khan Academy & more,
              and real-time progress tracking — all personalized for you.
            </p>
          </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full h-12 gradient-primary text-primary-foreground font-semibold text-base gap-2 hover:opacity-90 transition-opacity">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-12 border-border hover:bg-muted/50" onClick={() => navigate("/dashboard")}>
